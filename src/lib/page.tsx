 ...
 *
 * Every field here states something that is true and is also stated in plain
 * text on the page — no ratings, no review counts, no employee numbers. Markup
 * that claims more than the page shows is what gets a site penalised, and an
 * invented star rating is exactly the kind of thing Google acts on.
 */
  ...
  return (
    <>
      <script
        ...
        // The object is built above from our own constants, never from user
        // input, so there is nothing here that could carry injected markup.
